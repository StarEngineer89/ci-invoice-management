...
<html>
	<head>
		<title>Report Donor Child Sponsor Payment</title>
		<style type="text/css">
			#thanksletter
			{	
				float:left;
	...
	<body style="margin:0px auto;">
        ...
        <div style="width:6.5in;height:10.8in;border:solid black 0px;margin:.1in 1in;padding:0px;">
            ...
            <hr />
            <div style="text-align:center; font-size: 15px"><h2>Report Donor Child Sponsor Payment</h2></div>
            <div style="text-align:left; font-size: 13px;"><p>Donor Name : <b><?php echo @$list[0]['donor_name_payment']?></b>
            &nbsp;&nbsp;&nbsp;&nbsp;Address : <b><?php echo (@$list[0]['donor_address'])?></b>
            &nbsp;&nbsp;&nbsp;&nbsp; City : <b><?php echo (@$list[0]['city_name'])?></b>
            </p></div>
            <div style="text-align:left; font-size: 13px;"><p>Contact No : <b><?php echo @$list[0]['contact_no']?></b>
            &nbsp;&nbsp;&nbsp;&nbsp;Email : <b><?php echo (@$list[0]['donor_email'])?></b>
            &nbsp;&nbsp;&nbsp;&nbsp; Office : <b><?php echo (@$list[0]['donor_officeaddress'])?></b>
            </p></div> 
             <div style="text-align:left; font-size: 13px;"><p>From Date : <b><?php echo $fromDate; ?></b>
                    ...
                    <table >
                        <thead>
                            <tr>
                                ...
                                <th width="30%" style="border-bottom: 1px solid #000000; font-weight: bold;">Child Name</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td width="20%"><?php echo @$row['orphan_childName']?></td>
                                <td width="20%"><?php echo @$row['purpose']?></td>
