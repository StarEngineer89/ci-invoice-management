                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li >Report</li>
                            <li class="active">Citywise Donation Type </li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                    <div class="col-xs-12">
                                        <form action="<?=base_url()?>report/rep_citywise_donation_type_filter" target="_blank" method="post" id="textAlertReportForm" class="form-horizontal">
