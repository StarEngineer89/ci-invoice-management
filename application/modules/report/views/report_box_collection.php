                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li >Report</li>
                            <li class="active">Box Collection Detail </li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                    <div class="col-xs-12">
                                        <form action="<?=base_url()?>report/rep_box_collection_filter" target="_blank" method="post" id="topDonationReportForm" class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-1 control-label" for="route">Route</label>
                                                <div class="col-md-2">
                                                    <select id="route" name="route">
                                                        <option value="0">All</option>
                                                        <?php $route=$this->mdl_general->GetAllInfo('dn_root','root_id',array('root_active'=>"1"));
                                                        foreach($route as $row){
                                                        ?>
                                                        <option value="<?=$row['root_id']?>"><?=$row['root_name']?></option>
                                                        <?php }?>
