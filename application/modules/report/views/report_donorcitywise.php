                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li >Report</li>
                            <li class="active">Donor Citywise Report</li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                    <div class="col-xs-12">
                                        <form action="<?=base_url()?>report/rep_donorcitywise_filter" target="_blank" method="post" id="donorCityWiseReportForm" class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-2 control-label" for="donorHomeCity">City is donor's home city </label>
                                                <div class="col-md-1">
                                                    <input type="checkbox" name="donorHomeCity" id="donorHomeCity" class="form-control" value="1">
                                                </div>
