                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li >Report</li>
                            <li class="active">Pledge Summary</li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                    <div class="col-xs-12">
                                        <form action="<?=base_url()?>report/rep_pledgesummary_filter" target="_blank" method="post" id="pledgeSummaryReportForm" class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-md-1 control-label" for="pledgeCity">City</label>
                                                <div class="col-md-2">
                                                    <select name="pledgeCity" id="pledgeCity" class="form-control">
                                                ...
                                                <label class="col-md-1 control-label" for="pledgeEvent">Event</label>
                                                <div class="col-md-2">
                                                    <select name="pledgeEvent" id="pledgeEvent" class="form-control">
                                                        <option value="0">ALL</option>
                                                ...
                                                <label class="col-md-1 control-label" for="pledgeDonorType">Donor Type</label>
                                                <div class="col-md-2">
                                                    <select name="pledgeDonorType" id="pledgeDonorType" class="form-control">
                                                        <option value="0">ALL</option>
                                                ...
                                                <label class="col-md-1 control-label" for="pledgePaid">Paid</label>
                                                <div class="col-md-2">
                                                    <select name="pledgePaid" id="pledgePaid" class="form-control">
                                                        <option value="0">ALL</option>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="donorCity">City is donor's home city </label>
                                                <div class="col-md-1">
                                                    <input type="checkbox" name="donorCity" id="donorCity" class="form-control" value="1">
                                                </div>
