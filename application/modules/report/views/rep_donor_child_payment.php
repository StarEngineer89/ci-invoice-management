                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li >Report</li>
                            <li class="active">Donor Child Sponsor Payment</li>
                        </ul><!-- /.breadcrumb -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                    <div class="col-xs-12">
                                        <form action="<?=base_url()?>report/rep_donor_child_filter_payment" target="_blank" method="post" id="activeBoxCollectionSummaryReportForm" class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="donor_name">Donor</label>
                                                <div class="col-md-2">
                                                   <select class="form-control" id="donor_name" name="donor_name" >
                                                        <option value=""> </option>
                                                        <?php foreach($donor_name_list as $row){?>
                                                            <option value="<?php echo $row['donor_id']?>"><?php echo $row['donor_name_payment'] . ' | ' . $row['donor_address']?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
