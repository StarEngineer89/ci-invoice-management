<?php 
$html='<h3 style="text-align:center">Report Expense Summary</h3><br>
	<div style="text-align:left">From : <b>'.$from.'</b>  To :<b>'.$to.'</b></div><br><br>
            	<table >
	                        <thead>
	                            <tr>
	                                <th align="left "width="20%" style="border-bottom: 1px solid #000000; font-weight: bold;" >Expense ID</th>
	                                <th width="40%" style="border-bottom: 1px solid #000000; font-weight: bold;">Supplier Name</th>
	                                <th width="20%" style="border-bottom: 1px solid #000000; font-weight: bold;">Event</th>
...
foreach($list as $row){
	...
	$html.='
            ...
            <td width="40%" style="font-size:10px">'.$row['sup_name'].'</td>
            <td width="20%" style="font-size:10px">'.$row['event_name'].'</td>
            <td width="10%" style="font-size:10px">'.$row['currency_name'].'</td>
            <td width="10%" style="font-size:10px" align="right">'.number_format($row['amount'],2).'</td>
        </tr>';
...
$pdf->SetTitle('Report Expense Summary');
//config setting
$name="Report Expense Summary ".Date('d-m-Y');
