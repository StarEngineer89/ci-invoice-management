                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                    <div class="col-xs-12">
                                        <form action="<?=base_url()?>report/rep_income_expenditure_filter" target="_blank" method="post" id="textAlertReportForm" class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                   <select required name="month" id="month" class="form-control">
                                                    ...
                                                    <?php $month=$this->mdl_general->GetAllInfo('dn_monthes','month_id');
                                                    foreach($month as $row){
                                                    ?>
                                                    <option value="<?=$row['month_id']?>"><?=$row['month_name']?></option>
                                                    <?php } ?>
                                                   </select>
                                                </div>
