        ...
        <div class="well col-md-5 center login-box">
        	<?php
					if($this->input->get('error')){
						...
						echo "<div class='alert alert-info'>Please login with your Email and Password.</div>";
					}
				?>
            
            <form class="form-horizontal" action="<?php echo base_url()?>login/do_login_customer" method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input name="user_email" type="text" class="form-control" maxlength="100" class="input username" placeholder="User Email" required>
                    </div>
