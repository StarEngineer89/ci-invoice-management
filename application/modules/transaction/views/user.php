...
<!--                        <div class="form-group">-->
<!--                            <label class="col-md-2 control-label" for="first_name">Full Name</label>-->
<!--                            <div class="col-md-4">-->
<!--                                <input type="text" id="name" name="fname" class="form-control" placeholder="First Name" />-->
<!--                            </div>-->
<!--                            <div class="col-md-2">-->
<!--                                <input type="text" id="logName" name="mname" class="form-control" placeholder="Middle Name" />-->
<!--                            </div>-->
<!--                            <div class="col-md-4">-->
<!--                                <input type="text" id="logName" name="lname" class="form-control" placeholder="Last Name" />-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-md-2 control-label" for="address">Address</label>-->
<!--                            <div class="col-md-4">-->
<!--                                <input type="text" id="name" name="address" class="form-control" placeholder="Name" />-->
<!--                            </div>-->
<!--                            <label class="col-md-2 control-label" for="city">City</label>-->
<!--                            <div class="col-md-4">-->
<!--                                <input type="text" id="logName" name="city" class="form-control" placeholder="Log Name" />-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="form-group">-->
<!--                            <label class="col-md-2 control-label" for="postcode">Postal Code</label>-->
<!--                            <div class="col-md-4">-->
<!--                                <input type="text" id="name" name="postcode" class="form-control" placeholder="Name" />-->
<!--                            </div>-->
<!--                        </div>-->
