...
$body_text = str_replace('{orderid}', $customer_order_list->orderid, $body_text);
$body_text = str_replace('{order_date}', $customer_order_list->order_date , $body_text);
$body_text = str_replace('{order_status}', $customer_order_list->order_status, $body_text);
$body_text = str_replace('{customer_id}', $customer_order_list->customer_id, $body_text);
$body_text = str_replace('{remarks}', $customer_order_list->remarks, $body_text);
$body_text = str_replace('{total_order}', $customer_order_list->total_order, $body_text);
$body_text = str_replace('{discount}', $customer_order_list->discount, $body_text);
$body_text = str_replace('{VAT}', $customer_order_list->VAT, $body_text);
