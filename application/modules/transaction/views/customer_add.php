                    ...
                    <div class="col-lg-10">
                        ...
                        <form action="<?php echo base_url()?>transaction/add_customer" id="defaultForm" method="post" class="form-horizontal" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="website" name="website" class="form-control" placeholder="http://" value="http://"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <?php $tmp_pwd = random_string(); ?>
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Password</label>
                                <div class="col-lg-6">
                                    <input type="password" id="password" name="password" class="form-control" placeholder="Password" value="<?php echo $tmp_pwd ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <input type="password" id="confirm_password" name="confirm_password" class="form-control" placeholder="Confirm Password" value="<?php echo $tmp_pwd ?>"/>
                                </div>
                            </div>
                             <div class="form-group">
