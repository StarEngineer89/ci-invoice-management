        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url('transaction/delivery_note')?>">Delivery Note</a></li>
                    <li><a href="#">Add</a></li>
                </ul>
            </div>
            <style type="text/css">
                                ...
                                <div class="row">
                                    ...
                                    <section>
                                        <div class="col-lg-10">
                                            ...
                                            <form action="<?php echo base_url()?>transaction/add_delivery_note" id="defaultForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Delivery Note No:</label>
                                                    <div class="col-lg-3">
                                                        <input type="text" class="form-control" name="delivery_note_no" id="delivery_note_no"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">Delivery Date:</label>
                                                    <div class="col-lg-3">
                                                        <input type="text" class="form-control" name="delivery_date" id="delivery_date" value="<?php echo date('Y-m-d')?>" />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="delivery_details" id="delivery_details" class="form-control" rows="5"></textarea>
                                                    </div>
                                                </div>
