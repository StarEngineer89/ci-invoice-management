    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
        ...
        <tbody>
            ...
            <tr style="background-color: <?php echo $row['color'];?>; color:white">
                <td class="center"><?php echo $row['order_no'];?></td>
                <td class="center"><?php echo $row['order_date'];?></td>
                <td class="center"><?php echo $row['invoice_no'];?></td>
                <td class="center"><?php echo $row['invoice_date'];?></td>
                <td class="center"><?php echo $row['complete_name'];?></td>
                <td class="center"><?php echo $row['total_order'];?></td>
                <td class="center"><?php echo $row['receive_amount'];?></td>
