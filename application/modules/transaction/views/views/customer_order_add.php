...
<style type="text/css">
 ...
 <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Add Customer Order</h2>
            ...
            <div class="row">
                ...
                <section>
                    <div class="col-lg-10">
                        ...
                        <form action="<?php echo base_url()?>transaction/add_customer_order" id="defaultForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Order Date:</label>
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" name="order_date" id="order_date" value="<?php echo date('Y-m-d')?>" />
                                </div>
                                <label class="col-lg-2 control-label">Order Status:</label>
                                <div class="col-lg-2">
                                    <select name="order_status" id="order_status" class="form-control">
                                        <?php $order_status = $this->mdl_general->GetAllInfoSorting('ims_status','status_id', 'status_id');
                            ...
                            <div class="form-group" id="donorNameView">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="CustomerName" name="CustomerName" class="form-control" autocomplete="off" />
                                    ...
                                    <input type="hidden" id="hddCustomerid" name="hddCustomerid" >
                                </div>
                                ...
                                <div class="col-md-2">
                                    <input type="text" id="home_postcode" name="home_postcode" class="form-control" />
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="text" id="business_postcode" name="business_postcode" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <label class="radio-inline"><input type="radio" name="camera_required" value="1">1</label>
                                    <label class="radio-inline"><input type="radio" name="camera_required" value="2">2</label>
                                    <label class="radio-inline"><input type="radio" name="camera_required" value="3">3</label>
                                </div>
                                <label class="col-lg-2 control-label">Mixer:</label>
                                <div class="col-lg-2">
                                    <label class="radio-inline"><input type="radio" name="mixer" value="Yes">Yes</label>
                                    <label class="radio-inline"><input type="radio" name="mixer" value="No">No</label>
                                </div>
                                <label class="col-lg-2 control-label">Studio:</label>
                                <div class="col-lg-2">
                                    <label class="radio-inline"><input type="radio" name="studio" value="Yes">Yes</label>
                                    <label class="radio-inline"><input type="radio" name="studio" value="No">No</label>
                                </div>
                            </div>
                            <div class="form-group">
                                 <label class="col-md-2 control-label" for="remarks">Album Type</label>
                                <div class="col-md-3">
                                    <input type="text" name="album_type" id="album_type" class="form-control">
                                </div>
                                <label class="col-md-2 control-label" for="remarks">No of Album</label>
                                <div class="col-md-3">
                                    <input type="text" name="no_of_album" id="no_of_album" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" >
                                <table class="navbar navbar-default" role="navigation" border="1" style="width: 90%;margin: auto; margin-left: 9%; border-bottom: 0; border-left: 0; border-right: 0">
                                    ...
                                    <tbody class='add_more_fields_div'>
                                        <tr>
                                            <td>
                                                <select name="services_item[]" id="services_item" class="form-control ">
                                                ...
                                                <input type="hidden" name="stat_vat[]" id="stat_vat">
                                            ...
                                            <td>
                                                <input type="text" name="service_amount[]" id="service_amount" style='text-align:right;' class="form-control .serviceAmount" onkeyup="service_amount_event()">
                                            </td>
                                            <td>
                                      ...
                                      <tr  style="border-left: 0; border-right: 0; border-top: 0; border-bottom: 0; ">
                                        ...
                                        <td><input type="text" id="sub_total" name="sub_total" value="0.00" class="form-control" onchange="totalServicesPerItem()" style="text-align: right; font-weight: bold; color: #178acc" />
                                    ...
                                    <tr  style="border-left: 0; border-right: 0; border-top: 0; border-bottom: 0">
                                        ...
                                        <td><input type="text" id="discount" name="discount" value="0.00" class="form-control" style="text-align: right; font-weight: bold; color: #178acc" onkeyup="total_discount()" />
                                    ...
                                    <tr  style="border-left: 0; border-right: 0; border-top: 0; border-bottom: 0">
                                        ...
                                        <td><input type="text" id="grand_total" name="grand_total" value="0.00" class="form-control" style="text-align: right; font-weight: bold; color: #178acc" />
...
function service_amount_event(){
    ...
    var _service_qty = parseFloat($("#service_qty").val()) || 1;
    // var _stat_vat = $("#stat_vat").val();
    // alert(_service_qty);
    ...
    var _service_total =0;
    _service_total = (_service_amount * _service_qty);
    // if(_stat_vat == 'NO'){
        
    // }else{
    //     _service_total = (_service_amount * _service_qty) * _service_vat;
    // }
...
var base_url = "<?php echo base_url()?>";
 $(".add_field_button").on('click', function(){
    ...
    var divV = $(".add_more_fields_div");
        ...
        tbl += "<td><input type='text' name='service_qty[]' readonly='readonly' id='service_qty' value='"+_service_qty+"' style='text-align:right;' class='form-control .service_qty' onkeyup='service_amount_event()'></td>";
        tbl += "<td><input type='text' name='service_amount[]'' id='service_amount' value='"+_service_amount+"' class='form-control' style='text-align:right;'></td>";
        ...
        tbl += "<td><input type='text' name='service_total[]' readonly='readonly' id='service_total' value='"+_service_total+"' class='form-control total_service' onchange='totalServicesPerItem()' style='text-align:right;'></td>";
        tbl += "<td>";
...
$("#services_item").change(function(){
    $.ajax({
        ...
        success: function(data) {
            ...
            // }else{
            //     _service_total = (data['price'] * _service_qty) * _service_vat;
            // }
            
            $("#service_total").val(_service_total.toFixed(2));
            totalServicesPerItem();
            // totalVATPerItem();
            total_discount();
        }
