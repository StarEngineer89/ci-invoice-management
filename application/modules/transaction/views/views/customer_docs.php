...
$body_text = str_replace('{customer_id}', $customer_list->customer_id, $body_text);
$body_text = str_replace('{fname} {mname} {lname}', $customer_list->fname.' '.$customer_list->mname.' '. $customer_list->lname , $body_text);
$body_text = str_replace('{home_address}', $customer_list->home_address, $body_text);
$body_text = str_replace('{home_postcode}', $customer_list->home_postcode, $body_text);
$body_text = str_replace('{business_name}', $customer_list->business_name, $body_text);
$body_text = str_replace('{office_address}', $customer_list->office_address, $body_text);
$body_text = str_replace('{office_postcode}', $customer_list->office_postcode, $body_text);
$body_text = str_replace('{customer_email}', $customer_list->customer_email, $body_text);
$body_text = str_replace('{mobile_no}', $customer_list->mobile_no, $body_text);
$body_text = str_replace('{home_number}', $customer_list->home_number, $body_text);
