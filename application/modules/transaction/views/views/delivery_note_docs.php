...
$body_text = str_replace('{id}', $delivery_note_list->id, $body_text);
$body_text = str_replace('{delivery_note_no}', $delivery_note_list->delivery_note_no, $body_text);
$body_text = str_replace('{delivery_date}', $delivery_note_list->delivery_date, $body_text);
$body_text = str_replace('{delivery_status}', $delivery_note_list->delivery_status, $body_text);
$body_text = str_replace('{delivery_details}', $delivery_note_list->delivery_details, $body_text);
