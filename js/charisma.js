$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'http://www.onyxprojects.xyz/grafx/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'http://www.onyxprojects.xyz/grafx/css/bootstrap-' + themeName + '.min.css');
        }
